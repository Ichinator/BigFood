 ...
 */
class Burger extends \Ichinator\CommandBundle\Entity\Burger implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Ichinator\\CommandBundle\\Entity\\Burger' . "\0" . 'id', '' . "\0" . 'Ichinator\\CommandBundle\\Entity\\Burger' . "\0" . 'name', '' . "\0" . 'Ichinator\\CommandBundle\\Entity\\Burger' . "\0" . 'price', '' . "\0" . 'Ichinator\\CommandBundle\\Entity\\Burger' . "\0" . 'description', '' . "\0" . 'Ichinator\\CommandBundle\\Entity\\Burger' . "\0" . 'image', '' . "\0" . 'Ichinator\\CommandBundle\\Entity\\Burger' . "\0" . 'imageFile', '' . "\0" . 'Ichinator\\CommandBundle\\Entity\\Burger' . "\0" . 'updatedAt', '' . "\0" . 'Ichinator\\CommandBundle\\Entity\\Burger' . "\0" . 'comments'];
        }
