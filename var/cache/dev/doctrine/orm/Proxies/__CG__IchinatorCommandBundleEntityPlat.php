 ...
 */
class Plat extends \Ichinator\CommandBundle\Entity\Plat implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Ichinator\\CommandBundle\\Entity\\Plat' . "\0" . 'id', '' . "\0" . 'Ichinator\\CommandBundle\\Entity\\Plat' . "\0" . 'name', '' . "\0" . 'Ichinator\\CommandBundle\\Entity\\Plat' . "\0" . 'price', '' . "\0" . 'Ichinator\\CommandBundle\\Entity\\Plat' . "\0" . 'description', '' . "\0" . 'Ichinator\\CommandBundle\\Entity\\Plat' . "\0" . 'image', '' . "\0" . 'Ichinator\\CommandBundle\\Entity\\Plat' . "\0" . 'imageFile', '' . "\0" . 'Ichinator\\CommandBundle\\Entity\\Plat' . "\0" . 'comments', '' . "\0" . 'Ichinator\\CommandBundle\\Entity\\Plat' . "\0" . 'updatedAt'];
        }
