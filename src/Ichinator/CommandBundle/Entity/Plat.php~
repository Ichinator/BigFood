 ...
 * @Vich\Uploadable
 * @ORM\Table(name="plat")
 * @ORM\Entity(repositoryClass="Ichinator\CommandBundle\Repository\PlatRepository")
 */
class Plat
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="Ichinator\NewsBundle\Entity\Comments", mappedBy="plat")
     */
